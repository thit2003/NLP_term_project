#!/usr/bin/env python3
"""
Simple CLI for Thai-English code-mixed sentiment analysis using a fine-tuned XLM-R Base model.
...
Usage:
  ...
  python sentiment_cli.py --model D:\\Sem_2_2025\\NLP\\NLP_term_project\\multilingual_model --text "It is not the one I order"
